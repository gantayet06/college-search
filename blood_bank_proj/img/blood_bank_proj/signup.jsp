...
<%
    ...
    try {
        ...
        String sql = "INSERT INTO blood_bank_users " +
                     "(first_name, last_name, email, phone_number, street_address, city, state, zip_code, country, date_of_birth, gender, blood_group, weight, username, password) " +
